             ...
             <div class="col-md-12">
                 <div class="panel panel-default">
                     <div class="panel-heading">
                         ...
                         <div class="col-md-6">
                             <a href="{{route('admin.prods')}}" class="btn btn-success pull-right">All Prods</a>
                         </div>
                         </div>
                     </div>
                     <div class="panel-body">
                        ...
                        @endif
                         <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="updateProd">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @else
                                        <img src="{{asset('assets/images/prods')}}/{{$image}}" width="120" />
                                    @endif
                                </div>
                            </div>
