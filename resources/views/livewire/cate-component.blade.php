...
<div class="container">
    ...
    <div class="wrap-breadcrumb">
        <ul>
            ...
            <li class="item-link"><span>Kategorie</span></li>
            <li class="item-link"><span>{{$cate_name}}</span></li>
        </ul>
    </div>
    <div class="row">
        ...
        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
            ...
            <div class="wrap-shop-control">
                ...
                <h1 class="shop-title">{{$cate_name}}</h1>
                ...
                <div class="wrap-right">
                    ...
                    <div class="sort-item orderby ">
                        <select name="orderby" class="use-chosen" wire:model="sorting" >
                            ...
                            <option value="price">Cena: od najtanieszej</option>
                            <option value="price-desc">Cena: od najdroższej</option>
                        </select>
                    </div>
